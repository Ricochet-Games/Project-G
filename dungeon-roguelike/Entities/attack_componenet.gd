...
@warning_ignore("shadowed_variable") ## This 100% can and should be comblined with preform attack skill so that its just 1 method rather than 2 
...
func perform_attack_skill(attack_skill: AttackSkillData) -> void:
    create_hitboxes(attack_skill.damage, attack_skill.hitbox_scenes)
